...
public class MovementPath : MonoBehaviour
{
    ...
    public int startFrom = 0; //used to identify point in PathSequence we are moving to
    ...
    public IEnumerator<Transform> GetNextPathPoint()
    {
        ...
        if (PathSequence == null || movingTo < 1)
        {
        ...
        while(true) //Does not infinite loop due to yield return!!
        {
            ...
            yield return PathSequence[startFrom];
            //*********************************PAUSES HERE******************************************************//
            ...
            startFrom = startFrom + movementDirection;  
